        ...
        while True:
            ...
            if create_action_1 == "2":
                ...
                if not students_in_list_name:
                    ...
                    for student_class in students_in_list_name:
                        print(f"- {student_class['class']}")

                    print("\nTeachers of these classes:")
                    for student_class in students_in_list_name:
                        class_name = student_class['class']
                        teachers_in_class = [teacher for teacher in teachers if class_name in teacher["class"]]

                        print(f"\nTeachers for class {class_name}:")
